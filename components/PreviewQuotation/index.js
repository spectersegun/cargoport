  ...
  return (
    <section className="quotation-page client-bg preview">
      <div className="row top-bar-space">
        ...
        <div className="row mt-5 pt-lg-2">
          <div className="col-auto">
            <Link href="/admin-confirm-quotation">
              <button className="our-btn">Confirm Quotation</button>
            </Link>
          </div>
          <div className="col-auto">
            <Link href="/admin-prepare-quotation">
              <button className="our-btn our-btn-white">Edit Quotation</button>
            </Link>
          </div>
        </div>
      </div>
